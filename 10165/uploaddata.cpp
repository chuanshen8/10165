...
//    sg_ProductData.m_gas=1;
//    sg_ProductData.m_gas1=2;
//    sg_ProductData.m_humidity1=1;
//    sg_ProductData.m_humidity2=2;
//    sg_ProductData.m_temperature1=1;
//    sg_ProductData.m_temperature2=2;
//    sg_ProductData.m_illumination1=1;
//    sg_ProductData.m_illumination2=2;

    sg_ProductData.m_gas=current2.gas;
    sg_ProductData.m_gas1=current1.gas;
    sg_ProductData.m_humidity1=current1.humidity;
    sg_ProductData.m_humidity2=current2.humidity;
    sg_ProductData.m_temperature1=current1.temperature;
    sg_ProductData.m_temperature2=current2.temperature;
    sg_ProductData.m_illumination1=current1.illumination;
    sg_ProductData.m_illumination2=current2.illumination;
}
...
//    DeviceProperty plat_info[] = {
//        {.key = "module_hardinfo", .type = TYPE_TEMPLATE_STRING, .data = (void*)"ESP8266"},
//        {.key = "module_softinfo", .type = TYPE_TEMPLATE_STRING, .data = (void*)"V1.0"},
//        {.key = "fw_ver", .type = TYPE_TEMPLATE_STRING, .data = (void*)QCLOUD_IOT_DEVICE_SDK_VERSION},
//        {.key = "imei", .type = TYPE_TEMPLATE_STRING, .data = (void*)"11-22-33-44"},
//        {.key = "lat", .type = TYPE_TEMPLATE_STRING, .data = (void*)"22.546015"},
//        {.key = "lon", .type = TYPE_TEMPLATE_STRING, .data =(void*) "113.941125"},
//        {.key = NULL, .data = NULL}  // end
//    };

//    /*self define info*/
//    DeviceProperty self_info[] = {
//        {.key = "append_info", .type = TYPE_TEMPLATE_STRING, .data = (void*)"your self define info"},
//        {.key = NULL, .data = NULL}  // end
//    };
